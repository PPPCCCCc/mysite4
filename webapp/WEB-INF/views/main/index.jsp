...
<link href="/mysite4.1/assets/css/main.css" rel="stylesheet" type="text/css">
...
<body>
	<div id="wrap">
		...
		<div id="container" class="clearfix">
			...
			<div id="full-content">
				...
				<div id="index">
					...
					<img id="profile-img" src="/mysite4.1/assets/image/profile.jpg">

					<div id="greetings">
						<p class="text-xlarge">
							<span class="bold">안녕하세요!!<br> 박찬희의 MySite에 오신 것을
							...
							<br> (자유롭게 꾸며보세요!!)<br> <br> <br> <a class=""
								href="/mysite4/guestbook/addList">[방명록에 글 남기기]</a>
						</p>
					</div>
					<!-- //greetings -->
		...
		<div id="footer">Copyright ⓒ 2022 박찬희. All right reserved</div>
		<!-- //footer -->
