			...
			<div id="board">
				<div id="writeForm">
					<form action="${pageContext.request.contextPath}/rboard/comment" method="get">
						...
						<input type="hidden" name="userNo" value="${rBoardVo.groupNo }">
						<input type="hidden" name="userNo" value="${rBoardVo.orderNo }">
						<input type="hidden" name="userNo" value="${rBoardVo.depth }">
					</form>
					<!-- //form -->
				</div>
				<!-- //writeForm -->
